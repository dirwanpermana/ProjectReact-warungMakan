const foodMenu = [
  ...
  {
    nama: "Nasi Bebek",
    deskripsi: "Bebek Goreng dengan aroma yang membuat perut bergetar",
    harga: 23000,
    foto: "food/bebek.jpg",
    stok: Math.random() >= 0.5 ? true : false,
  },
...
export default foodMenu; //tambahkan export default (nama variabel) agar data nya dapat digunakan di index.js
